...
### 일반 현황
 - 인원 : 국군지휘통신사령부 육군상병 박지호, 15보병사단 육군일병 양해찬
...
### 향후 추진 계획
 ...
 - 인터넷망에 군 조직도를 둘 수는 없으므로 보안적인 측면을 고려해서 기능을 개선이 필요하다.
...
군번, 실명, 이름, 전화번호로 회원가입이 가능하다. 전화번호는 승인 시 타인에게 보여줄 수 있어 빠른 연락이 필요할 때 사용할 수 있다.
